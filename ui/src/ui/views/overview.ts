      ...
      return html`
        <div class="muted" style="margin-top: 8px">
          ...
          <div style="margin-top: 6px">
            <span class="mono">billbot dashboard --no-open</span> → open the Dashboard<br />
            <span class="mono">billbot doctor --generate-gateway-token</span> → set token
          </div>
          <div style="margin-top: 6px">
            <a
              class="session-link"
              href="https://docs.billbot.app/web/dashboard"
              target="_blank"
              rel="noreferrer"
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.billbot.app/gateway/tailscale"
            target="_blank"
            rel="noreferrer"
          ...
          <a
            class="session-link"
            href="https://docs.billbot.app/web/control-ui#insecure-http"
            target="_blank"
            rel="noreferrer"
              ...
              : html`
                <label class="field">
                  ...
                  <input
                    ...
                    placeholder="BILLBOT_GATEWAY_TOKEN"
                  />
                </label>
                <label class="field">
